import { ItemId, MapId, MissionData, MissionId, MissionSetId } from '../../types'
...
// export const missionSetMissions: MissionSetMissions = missionData.reduce(
//     (acc: MissionSetMissions, cur: MissionData) => {
